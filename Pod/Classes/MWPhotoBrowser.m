...
- (void)viewDidLoad {
  ...
  if (self.displayActionButton) {
    if (_actionButtonImage != nil) {
      _actionButton = [[UIBarButtonItem alloc] initWithTitle:nil style:UIBarButtonItemStylePlain target:self action:@selector(actionButtonPressed:)];
      [_actionButton setImage:_actionButtonImage];
    }
    else {
...
- (void)performLayout {
  ...
  if ([self.navigationController.viewControllers objectAtIndex:0] == self) {
    ...
    _doneButton = [[UIBarButtonItem alloc] initWithTitle:nil style:UIBarButtonItemStylePlain target:self action:@selector(doneButtonPressed:)];
    // Set appearance
...
- (void)setDoneButtonImage:(UIImage *)img {
  _doneButtonImage = img;
}


- (void)setActionButtonImage:(UIImage *)img {
  _actionButtonImage = img;
}
